      ...
      <nav className="mx-auto flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <Link to="/" className="-m-1.5 p-1.5">
            ...
            <img className="logo" src={process.env.PUBLIC_URL + 'techflix.png'} alt="LOGO " />
          </Link>
        </div>
...
{/* 
            ...
            <Link to="/profile" className="text-md font-semibold leading-6 text-gray-900">
              Profil
            </Link>
          </Popover.Group>
        }
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          {props.user.id ?
            <Link className="text-md font-semibold leading-6 text-gray-900" onClick={() => {
              props.onLogout({});
              sessionStorage.removeItem('userTechFlix');
              sessionStorage.removeItem('TechFlixToken');
              navigation('/')
