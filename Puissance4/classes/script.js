export default class p4 {
  ...
  drawGame() {
    ...
    leaderboard.innerHTML = `Score : <br><br> ${this.p1} : ${p4.score1} <br><br> ${this.p2} : ${p4.score2}`;
    leaderboard.style.setProperty('position', 'fixed');
    leaderboard.style.setProperty('top', '20%');
    leaderboard.style.setProperty('right', '5%');
    leaderboard.style.setProperty('width', '5%');
    leaderboard.style.setProperty('padding', '10px');
    leaderboard.style.backgroundColor = "#ccc"
    leaderboard.style.border = "2px black solid"
    ...
    function checkrow() {
      ...
      tokens.forEach(element => {
        ...
        if (d1 === null || d2 === null || d3 === null) {
          ...
          p4.score1++;
          self.leaderboard.innerHTML = `Score : <br><br> ${self.p1} : ${p4.score1} <br><br> ${self.p2} : ${p4.score2}`;
